    ...
    public static class FastIO {
        ...
        public String[] readStringArray() {
            if (STRING_ARRAY == null) {
                STRING_ARRAY = new String[1000010];
            }
            int size = 0;
            while (true) {
                try {
        ...
        // MAX string SK
        public int MAX_STRING_LENGTH = (int) 1e6 + 1;
        ...
        public void printArray(int[] arr, int st, int end) {
            print("[");
        ...
        public void printArray(long[] arr, int st, int end) {
            print("[");
            for (int i = st; i < end; i++) {
                io.print(arr[i]);
                if (i != end - 1) {
        ...
        public void printArray(int[][] arr, int rowStart, int rowEnd, int colStart, int colEnd) {
            print("[\n");
